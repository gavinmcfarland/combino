...
const arrayMerge = (targetArray, sourceArray) => {
    ...
    const allPrimitives = allItems.every((item) => typeof item === "string" ||
        typeof item === "number" ||
        typeof item === "boolean");
    if (allPrimitives) {
...
export async function mergeJson(targetPath, sourcePath, strategy, baseTemplatePath, data, templateEngine) {
